...
function renderProducts(productsToRender, container) {
    ...
    productsToRender.forEach(product => {
        ...
        productCard.innerHTML = `
            ...
            <a href="https://wa.me/527291080492?text=Quisiera%20comprar%20el%20producto:%20'${encodeURIComponent(product.name)}'.%20%C2%BFEst%C3%A1%20disponible?'${encodeURIComponent(product.name)}'." 
               target="_blank" 
